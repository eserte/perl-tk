...
I<$menu> = I<$parent>-E<gt>B<Menu>(?I<options>?);
...
E<lt>E<lt>E<lt>E<lt>E<lt>E<lt>E<lt> /home/perl5/NI-S/Tk8/doc/mann/tmp.7542.77
...
B<toplevel> command for syntax). On the Macintosh, whenever the
...
made. See the B<CLONES> section for more information.
...
=item $widget B<clone> I<newPathname ?cloneType?>

Makes a clone of the current menu named I<newPathName>. This clone
...
called outside of the Tk library. See the B<CLONES> section for
more information.
...
=item I<$menu>-E<gt>B<insert>(I<index, >I<type, >?I<option, value, option, value, ...>?)
...
command when the entry was created, such as B<command>
