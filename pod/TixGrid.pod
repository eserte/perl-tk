...
##
## methods:
##	anchor:    what is required 'option' arg?
...
B<Undocumented (also in Tix manpage):>
-floatingcols (=0),
-floatingrows (=0),
-itemtype (=text),
-sizecmd (=undef),
...
the area where the the horizontal and vertical margins are joined
...
=item I<$tixgrid>->B<anchor>(I<option>?, I<args>, I<...>?)
...
I<Dim> may be B<row> or B<column>. Moves the the range of rows
...
the the widest cell in the column; a valid Tk screen distance
...
I<Default bindings not implemented.>
