...
I<$response> = I<$widget>-E<gt>B<messageBox>(-option =E<gt> value, ... );

=head1 DESCRIPTION

This method uses B<Tk::Dialog> to quickly create several common dialog boxes.
...
many times, the B<messageBox> window is created every time its used.
