...
=item I<$widget>-E<gt>B<addtag>(I<tag, searchSpec, >?I<arg, arg, ...>?)
...
=item I<$widget>-E<gt>B<bbox>(I<tagOrId, >?I<tagOrId, tagOrId, ...>?)
...
=item I<$widget>-E<gt>B<canvasy>(I<screeny, >?I<gridspacing>?)
...
=item I<$widget>-E<gt>B<create>(I<type, x, y, >?I<x, y, ...>?, ?I<option, value, ...>?)
...
=item I<$widget>-E<gt>B<dchars>(I<tagOrId, first, >?I<last>?)
...
=item I<$widget>-E<gt>B<delete>(?I<tagOrId, tagOrId, ...>?)

Delete each of the items given by each I<tagOrId>, and return
an empty string.

=item I<$widget>-E<gt>B<dtag>(I<tagOrId, >?I<tagToDelete>?)
...
=item I<$widget>-E<gt>B<find>(I<searchCommand, >?I<arg, arg, ...>?)
...
=item I<$widget>-E<gt>B<focus>(?I<tagOrId>?)
...
=item I<$widget>-E<gt>B<gettags>(I<tagOrId>)
...
=item I<$widget>-E<gt>B<icursor>(I<tagOrId, index>)
...
=item I<$widget>-E<gt>B<index>(I<tagOrId, index>)
...
=item I<$widget>-E<gt>B<insert>(I<tagOrId, beforeThis, string>)
...
=item I<$widget>-E<gt>B<itemcget>(I<tagOrId, >I<option>)
...
=item I<$widget>-E<gt>B<itemconfigure>(I<tagOrId, >?I<option>?, ?I<value>?, ?I<option, value, ...>?)
...
=item I<$widget>-E<gt>B<lower>(I<tagOrId, >?I<belowThis>?)
...
=item I<$widget>-E<gt>B<move>(I<tagOrId, xAmount, yAmount>)
...
=item I<$widget>-E<gt>B<postscript>(?I<option, value, option, value, ...>?)
...
=item I<$widget>-E<gt>B<raise>(I<tagOrId, >?I<aboveThis>?)
...
=item I<$widget>-E<gt>B<scale>(I<tagOrId, xOrigin, yOrigin, xScale, yScale>)
...
=item I<$widget>-E<gt>B<scanMark>(I<x, y>)
...
=item I<$widget>-E<gt>B<scanDragto>(I<x, y, ?gain?>.)
...
=item I<$widget>-E<gt>B<select>(I<option, >?I<tagOrId, arg>?)
...
=item I<$widget>-E<gt>B<selectAdjust>(I<tagOrId, index>)
...
=item I<$widget>-E<gt>B<selectClear>
...
=item I<$widget>-E<gt>B<selectFrom>(I<tagOrId, index>)
...
=item I<$widget>-E<gt>B<selectItem>
...
=item I<$widget>-E<gt>B<selectTo>(I<tagOrId, index>)
...
=item I<$widget>-E<gt>B<type>(I<tagOrId>)
...
=item I<$widget>-E<gt>B<yview>(I<?args>?)
...
=item I<$widget>-E<gt>B<yviewMoveto>(I<fraction>)
...
=item I<$widget>-E<gt>B<yviewScroll>(I<number, what>)
...
Arcs are created with methods of the following form:
 ...
 $widget->createArc(x1, y1, x2, y2, ?option, value, option, value, ...?)
...
Bitmaps are created with methods of the following form:
 ...
 $widget->createBitmap(x, y, ?option, value, option, value, ...?)
...
following form:
 ...
 $widget->createGrid(x1, y1, x2, y2, ?option, value, option, value, ...?)
...
If I<color> is an empty string then no grid will be drawn.
...
Images are created with methods of the following form:
 ...
 $widget->createImage(x, y, ?option, value, option, value, ...?)
...
Lines are created with methods of the following form:
 ...
 $widget->createLine(x1, y1..., xn, yn, ?option, value, option, value, ...?)
...
following form:
 ...
 $widget->createOval(x1, y1, x2, y2, ?option, value, option, value, ...?)
...
Polygons are created with methods of the following form:
 ...
 $widget->createPolygon(x1, y1, ..., xn, yn, ?option, value, option, value, ...?)
...
following form:
 ...
 $widget->createRectangle(x1, y1, x2, y2, ?option, value, option, value, ...?)
...
form:
 ...
 $widget->createText(x, y, ?option, value, option, value, ...?)
...
disabled states.
I<Color> may have any of the forms accepted by B<Tk_GetColor>.
If I<color> is an empty string then the text will be transparent.
