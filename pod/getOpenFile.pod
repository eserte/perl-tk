...
=head1 DESCRIPTION
	...
	The current implementation of getOpen/Save File does
	not work exactly as documented here (at least on Unix).
	Work in progress ...
...
Note: On Unix the '.' is automaticly added so use B<pm> if you want that
B<.pm> gets appended as default.
...
See F<pod/TODO> in the perl/Tk distribution for a list of known bugs
