...
=item I<$widget>-E<gt>B<font>(B<actual>, I<font>?, I<-option>?)

=item I<$widget>-E<gt>B<fontActual>(I<font>?, I<-option>?)

Returns information about the actual attributes that are obtained when
I<font> is used on I<$widget>'s display; the actual attributes obtained
...
=item I<$widget>-E<gt>B<font>(B<configure>, I<fontname>?, I<-option>??=>I<value>, I<-option>=>I<value>, ...?)

=item I<$widget>-E<gt>B<fontConfigure>(I<fontname>?, I<-option>??=>I<value>, I<-option>=>I<value>, ...?)
...
=item I<$widget>-E<gt>B<font>(B<create>?, I<fontname>??, I<-option>=>I<value>, ...>?)

=item I<$widget>-E<gt>B<fontCreate>(?I<fontname>??, I<-option>=>I<value>, ...>?)
...
of I<option-value> pairs, which provide the desired attributes for
...
=item I<$widget>-E<gt>B<font>(B<delete>, I<fontname>?, I<fontname>, ...?)
...
=item I<$widget>-E<gt>B<font>(B<families>)
...
=item I<$widget>-E<gt>B<font>(B<measure>, I<font>, I<text>)
...
=item I<$widget>-E<gt>B<font>(B<metrics>, I<font>?, I<-option>?)
...
=item I<$widget>-E<gt>B<font>(B<names>)
...
The following options are used by the B<fontMetrics> method to query
...
can be overridden by calling the L<scaling|Tk::Widget/scaling> command.
