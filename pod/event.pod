...
B<MainWindow>.  Different B<MainWindow> can have different
virtual event.
...
argument of the B<bind> command except that it must consist
...
allowed in binding callback for the B<bind> method.
...
Corresponds to the B<%a> substitution for binding scripts.
...
Corresponds to the B<%c> substitution for binding scripts.
...
B<FocusOut> events.
Corresponds to the B<%d> substitution for binding scripts.
...
Corresponds to the B<%f> substitution for binding scripts.
...
Corresponds to the B<%h> substitution for binding scripts.
...
Corresponds to the B<%k> substitution for binding scripts.
...
Valid for B<Enter>, B<Leave>, B<FocusIn>, and
B<FocusOut> events.
Corresponds to the B<%m> substitution for binding scripts.
...
Corresponds to the B<%o> substitution for binding scripts.
...
Corresponds to the B<%p> substitution for binding scripts.
...
events.
Corresponds to the B<%R> substitution for binding scripts.
...
Valid for B<KeyPress>, B<KeyRelease>, B<ButtonPress>,
B<ButtonRelease>, B<Enter>, B<Leave>, and B<Motion>
events.  Corresponds to the B<%X> substitution for binding scripts.
...
Corresponds to the B<%s> substitution for binding scripts.
...
Valid for B<KeyPress>, B<KeyRelease>, B<ButtonPress>,
B<ButtonRelease>, B<Enter>, B<Leave>, and B<Motion> events.
Similar to B<%S> substitution for binding scripts.
...
Corresponds to the B<%t> substitution for binding scripts.
...
for the event.
Valid for B<Configure> events.
Corresponds to the B<%w> substitution for binding scripts.
...
events.
Corresponds to the the B<%x> substitution for binding scripts.
...
B<Expose>, B<Configure>, B<Gravity>, and B<Reparent>
events.
Corresponds to the the B<%y> substitution for binding scripts.
