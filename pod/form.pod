...
form - Geometry manager based on attachment rules
...
integer value. For example, B<'%0'> spceifies the first grid
...
B<ABBREVIATIONS:> Certain abbreviations can be made on the
