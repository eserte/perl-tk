...
$widget argument) and makes it into a text widget.
Additional
...
I<State> specifies if the text is I<hidden> or I<normal>.
...
=item I<$widget>-E<gt>B<delete>(I<index1, >?I<index2>?)
...
=item I<$widget>-E<gt>B<dlineinfo>(I<index>)
...
=item I<$widget>-E<gt>B<dump>(?I<switches>?, I<index1, >?I<index2>?)
...
B<tagon>, B<tagoff>, and I<$widget>.  The corresponding
...
=item I<$widget>-E<gt>B<get>(I<index1, >?I<index2>?)
...
the one whose index is I<index2> (the character at I<index2>
will not be returned).
If I<index2> is omitted then the single character at I<index1>
is returned.
...
=item I<$widget>-E<gt>B<imageCget>(I<index, option>)
...
=item I<$widget>-E<gt>B<imageConfigure>(I<index, >?I<option, value, ...>?)
...
=item I<$widget>-E<gt>B<imageCreate>(I<index, >?I<option, value, ...>?)
...
=item I<$widget>-E<gt>B<insert>(I<index, chars, >?I<tagList, chars, tagList, ...>?)
...
=item I<$widget>-E<gt>B<mark>(I<option, >?I<arg, arg, ...>?)
...
=item I<$widget>-E<gt>B<markGravity>(I<markName, >?I<direction>?)
...
=item I<$widget>-E<gt>B<markNames>

Returns a list whose elements are the names of all the marks that
are currently set.

=item I<$widget>-E<gt>B<markNext>(I<index>)
...
=item I<$widget>-E<gt>B<markPrevious>(I<index>)
...
=item I<$widget>-E<gt>B<markSet>(I<markName, index>)
...
=item I<$widget>-E<gt>B<scanDragto>(I<x, y>)
...
=item I<$widget>-E<gt>B<tag>(I<option, >?I<arg, arg, ...>?)
...
=item I<$widget>-E<gt>B<tagAdd>(I<tagName, index1, >?I<index2, index1, index2, ...>?)
...
=item I<$widget>-E<gt>B<tagBind>(I<tagName, >?I<sequence>?, ?I<script>?)
...
=item I<$widget>-E<gt>B<tagConfigure>(I<tagName, >?I<option>?, ?I<value>?, ?I<option, value, ...>?)
...
=item I<$widget>-E<gt>B<tagDelete>(I<tagName, >?I<tagName, ...>?)
...
=item I<$widget>-E<gt>B<tagNames>(?I<index>?)
...
=item I<$widget>-E<gt>B<tagNextrange>(I<tagName, index1, >?I<index2>?)
...
=item I<$widget>-E<gt>B<tagPrevrange>(I<tagName, index1, >?I<index2>?)
...
=item I<$widget>-E<gt>B<tagRaise>(I<tagName, >?I<aboveThis>?)
...
=item I<$widget>-E<gt>B<tagRanges>(I<tagName>)
...
=item I<$widget>-E<gt>B<tagRemove>(I<tagName, index1, >?I<index2, index1, index2, ...>?)
...
=item I<$widget>-E<gt>B<yview>(I<number>)
