...
name of a I<$widget> display style that has already be created with 
the B<ItemStyle)>.
...
S<   >I<$widget>-E<gt>B<ItemStyle>(<itemType>,?I<-stylename name>?,?I<-refwindow pathName>? ?I<options value ...>?);
