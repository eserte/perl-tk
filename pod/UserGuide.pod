...
have it and Tk running.  If you are not currently reading this
document courtesy of the B<widget> demonstration program, please be
sure to run B<widget>, as it will teach you the various widget types
...
calling B<MainLoop> - watches all events of interest and activate
