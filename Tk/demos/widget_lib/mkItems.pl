...
sub mkItems {
    ...
    $c->create(qw(line 1c 5c 7c 5c 7c 7c 9c 7c -width .5c), -stipple => "\@$tk_library/demos/images/grey.25",
    ...
    $c->create(qw(line 12c 6c 13.5c 4.5c 16.5c 7.5c 18c 6c 16.5c 4.5c 13.5c 7.5c 12c 6c -smooth on -width 3m -cap round),
	       -stipple => "\@$tk_library/demos/images/grey.25", -fill => $red, qw(-tags item));
    ...
    $c->create(qw(polygon 22c 4.5c 25c 4.5c 25c 6.75c 28c 6.75c 28c 5.25c 24c 5.25c 24c 6.0c 26c 6c 26c 7.5c 22c 7.5c),
	       -stipple => "\@$tk_library/demos/images/grey.25", qw( -tags item));
    ...
    $c->create(qw(rectangle 6c 10c 9c 15c), -outline => undef, -stipple => "\@$tk_library/demos/images/grey.25", -fill => $blue,
	       qw(-tags item));
    ...
    $c->create(qw(oval 16c 10c 19c 15c), -outline => undef, -stipple => "\@$tk_library/demos/images/grey.25", -fill => $blue,
	       qw(-tags item));
    ...
    $c->create(qw(text 25c 14c -anchor c), -font => $font2, -fill => $red, -stipple => "\@$tk_library/demos/images/grey.5",
    ...
    $c->create(qw(arc 6.5c 17c 9.5c 20c -width 4m -style arc), -fill => $blue, -stipple => "\@$tk_library/demos/images/grey.25",
    ...
    $c->create(qw(bitmap 13c 20c), -bitmap => "\@$tk_library/demos/images/face", qw(-tags item));
    $c->create(qw(bitmap 17c 18.5c), -bitmap => "\@$tk_library/demos/images/noletters", qw(-tags item));
    $c->create(qw(bitmap 17c 21.5c), -bitmap => "\@$tk_library/demos/images/letters", qw(-tags item));
