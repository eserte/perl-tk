...
sub floor {
    ...
    my $c = $w_frame->Canvas(
        -width          => '900',
        -height         => '500',
        -xscrollcommand => ['set', $w_hscroll],
	-yscrollcommand => ['set', $w_vscroll],
        -relief         => 'sunken',
        -bd => 2,
    );
    $c->pack(-expand => 'yes', -fill => 'both');
    $w_vscroll->configure(-command => ['yview', $c]);
    $w_hscroll->configure(-command => ['xview', $c]);
    ...
    $floor::currentRoom = '';
    $floor::c_entry = $c->Entry(-width => '10', -relief => 'sunken',
        -bd => '2', -textvariable => \$floor::currentRoom);

    # Choose colors, then fill in the floorplan.

    if ($w->depth > 1) {
	$floor::colors{'bg1'} = '#a9c1da';
	$floor::colors{'outline1'} = '#77889a';
	$floor::colors{'bg2'} = '#9ab0c6';
	$floor::colors{'outline2'} = '#687786';
	$floor::colors{'bg3'} = '#8ba0b3';
	$floor::colors{'outline3'} = '#596673';
	$floor::colors{'offices'} = 'Black';
	$floor::colors{'active'} = '#c4d1df';
    } else {
	$floor::colors{'bg1'} = 'white';
	$floor::colors{'outline1'} = 'black';
	$floor::colors{'bg2'} = 'white';
	$floor::colors{'outline2'} = 'black';
	$floor::colors{'bg3'} = 'white';
	$floor::colors{'outline3'} = 'black';
	$floor::colors{'offices'} = 'Black';
	$floor::colors{'active'} = 'black';
    }
    $floor::activeFloor = 0;
    floorDisplay $c, 3;
    ...
    $c->bind('room', '<Leave>' => sub {$floor::currentRoom = ''});
    $c->Tk::bind('<2>' => sub {
	my($c) = @ARG;
        my $e = $c->XEvent;
	$c->scan('mark', $e->x, $e->y);
...
#    $c->Tk::bind('<Destroy>' => sub {undef $floor::currentRoom});
...
sub floorDisplay {
    ...
    return if $floor::activeFloor eq $active;

    $w->delete('all');
    $floor::activeFloor = $active;

    # First go through the three floors, displaying the backgrounds for
    # each floor.

    bg1 $w, $floor::colors{'bg1'}, $floor::colors{'outline1'};
    bg2 $w, $floor::colors{'bg2'}, $floor::colors{'outline2'};
    bg3 $w, $floor::colors{'bg3'}, $floor::colors{'outline3'};
    ...
    $w->create('rectangle', 0, 100, 1, 101, -fill => undef, -outline => undef,
	       -tags => 'marker');
    ...
    eval 'undef $floor::floorLabels; undef $floor::floorItems';
    my $cmd = "fg${active}";
    &$cmd($w, $floor::colors{'offices'});
    $w->raise('room');
    ...
    $w->create('window', 600, 100, -anchor => 'w',
	       -window => $floor::c_entry);
...
sub roomChanged {
    ...
    # Whenever the currentRoom variable changes, this procedure highlights 
    # the current room and unhighlights any previous room.

    my($w) = @ARG;

    $w->delete('highlight');
    my $item = $floor::floorItems{$floor::currentRoom};
    return if not defined $item;
    my(@c) = $w->coords($item);
    if ($c[0]) {
	$w->raise(
            $w->create('polygon', @c,
	        -fill => $floor::colors{'active'},
	        -tags => 'highlight',
            ),
        'marker');
...
sub fg1 {
    ...
    $floor::floorLabels{$i} = 101;
    $floor::floorItems{'101'} = $i;
    ...
    $floor::floorLabels{$i} = 'Pub Lift1';
    $floor::floorItems{'Pub Lift1'} = $i;
    ...
    $floor::floorLabels{$i} = 'Priv Lift1';
    $floor::floorItems{'Priv Lift1'} = $i;
    ...
    $floor::floorLabels{$i} = 110;
    $floor::floorItems{'110'} = $i;
    ...
    $floor::floorLabels{$i} = 109;
    $floor::floorItems{'109'} = $i;
    ...
    $floor::floorLabels{$i} = 111;
    $floor::floorItems{'111'} = $i;
    ...
    $floor::floorLabels{$i} = '117B';
    $floor::floorItems{'117B'} = $i;
    ...
    $floor::floorLabels{$i} = 112;
    $floor::floorItems{'112'} = $i;
    ...
    $floor::floorLabels{$i} = 113;
    $floor::floorItems{'113'} = $i;
    ...
    $floor::floorLabels{$i} = '117A';
    $floor::floorItems{'117A'} = $i;
    ...
    $floor::floorLabels{$i} = 117;
    $floor::floorItems{'117'} = $i;
    ...
    $floor::floorLabels{$i} = 114;
    $floor::floorItems{'114'} = $i;
    ...
    $floor::floorLabels{$i} = 115;
    $floor::floorItems{'115'} = $i;
    ...
    $floor::floorLabels{$i} = 116;
    $floor::floorItems{'116'} = $i;
    ...
    $floor::floorLabels{$i} = 118;
    $floor::floorItems{'118'} = $i;
    ...
    $floor::floorLabels{$i} = 120;
    $floor::floorItems{'120'} = $i;
    ...
    $floor::floorLabels{$i} = 122;
    $floor::floorItems{'122'} = $i;
    ...
    $floor::floorLabels{$i} = 121;
    $floor::floorItems{'121'} = $i;
    ...
    $floor::floorLabels{$i} = '106A';
    $floor::floorItems{'106A'} = $i;
    ...
    $floor::floorLabels{$i} = 105;
    $floor::floorItems{'105'} = $i;
    ...
    $floor::floorLabels{$i} = '106B';
    $floor::floorItems{'106B'} = $i;
    ...
    $floor::floorLabels{$i} = 104;
    $floor::floorItems{'104'} = $i;
    ...
    $floor::floorLabels{$i} = 108;
    $floor::floorItems{'108'} = $i;
    ...
    $floor::floorLabels{$i} = 107;
    $floor::floorItems{'107'} = $i;
    ...
    $floor::floorLabels{$i} = 'Smoking';
    $floor::floorItems{'Smoking'} = $i;
    ...
    $floor::floorLabels{$i} = 123;
    $floor::floorItems{'123'} = $i;
    ...
    $floor::floorLabels{$i} = 103;
    $floor::floorItems{'103'} = $i;
    ...
    $floor::floorLabels{$i} = 124;
    $floor::floorItems{'124'} = $i;
    ...
    $floor::floorLabels{$i} = 125;
    $floor::floorItems{'125'} = $i;
    ...
    $floor::floorLabels{$i} = 126;
    $floor::floorItems{'126'} = $i;
    ...
    $floor::floorLabels{$i} = 127;
    $floor::floorItems{'127'} = $i;
    ...
    $floor::floorLabels{$i} = 'MShower';
    $floor::floorItems{'MShower'} = $i;
    ...
    $floor::floorLabels{$i} = 'Closet';
    $floor::floorItems{'Closet'} = $i;
    ...
    $floor::floorLabels{$i} = 'WShower';
    $floor::floorItems{'WShower'} = $i;
    ...
    $floor::floorLabels{$i} = 130;
    $floor::floorItems{'130'} = $i;
    ...
    $floor::floorLabels{$i} = 102;
    $floor::floorItems{'102'} = $i;
    ...
    $floor::floorLabels{$i} = 128;
    $floor::floorItems{'128'} = $i;
    ...
    $floor::floorLabels{$i} = 129;
    $floor::floorItems{'129'} = $i;
    ...
    $floor::floorLabels{$i} = 133;
    $floor::floorItems{'133'} = $i;
    ...
    $floor::floorLabels{$i} = 132;
    $floor::floorItems{'132'} = $i;
    ...
    $floor::floorLabels{$i} = 134;
    $floor::floorItems{'134'} = $i;
    ...
    $floor::floorLabels{$i} = 135;
    $floor::floorItems{'135'} = $i;
    ...
    $floor::floorLabels{$i} = 'Ramona Stair';
    $floor::floorItems{'Ramona Stair'} = $i;
    ...
    $floor::floorLabels{$i} = 'University Stair';
    $floor::floorItems{'University Stair'} = $i;
    ...
    $floor::floorLabels{$i} = 'Plaza Stair';
    $floor::floorItems{'Plaza Stair'} = $i;
    ...
    $floor::floorLabels{$i} = 'Plaza Deck';
    $floor::floorItems{'Plaza Deck'} = $i;
    ...
    $floor::floorLabels{$i} = 106;
    $floor::floorItems{'106'} = $i;
    ...
    $floor::floorLabels{$i} = 119;
    $floor::floorItems{'119'} = $i;
...
sub fg2 {;
    ...
    $floor::floorLabels{$i} = 238;
    $floor::floorItems{'238'} = $i;
    ...
    $floor::floorLabels{$i} = 237;
    $floor::floorItems{'237'} = $i;
    ...
    $floor::floorLabels{$i} = 246;
    $floor::floorItems{'246'} = $i;
    ...
    $floor::floorLabels{$i} = 247;
    $floor::floorItems{'247'} = $i;
    ...
    $floor::floorLabels{$i} = 202;
    $floor::floorItems{'202'} = $i;
    ...
    $floor::floorLabels{$i} = 206;
    $floor::floorItems{'206'} = $i;
    ...
    $floor::floorLabels{$i} = 212;
    $floor::floorItems{'212'} = $i;
    ...
    $floor::floorLabels{$i} = 245;
    $floor::floorItems{'245'} = $i;
    ...
    $floor::floorLabels{$i} = 244;
    $floor::floorItems{'244'} = $i;
    ...
    $floor::floorLabels{$i} = 243;
    $floor::floorItems{'243'} = $i;
    ...
    $floor::floorLabels{$i} = 242;
    $floor::floorItems{'242'} = $i;
    ...
    $floor::floorLabels{$i} = 'Barbecue Deck';
    $floor::floorItems{'Barbecue Deck'} = $i;
    ...
    $floor::floorLabels{$i} = 240;
    $floor::floorItems{'240'} = $i;
    ...
    $floor::floorLabels{$i} = 241;
    $floor::floorItems{'241'} = $i;
    ...
    $floor::floorLabels{$i} = 239;
    $floor::floorItems{'239'} = $i;
    ...
    $floor::floorLabels{$i} = 248;
    $floor::floorItems{'248'} = $i;
    ...
    $floor::floorLabels{$i} = 236;
    $floor::floorItems{'236'} = $i;
    ...
    $floor::floorLabels{$i} = 235;
    $floor::floorItems{'235'} = $i;
    ...
    $floor::floorLabels{$i} = 234;
    $floor::floorItems{'234'} = $i;
    ...
    $floor::floorLabels{$i} = 233;
    $floor::floorItems{'233'} = $i;
    ...
    $floor::floorLabels{$i} = 230;
    $floor::floorItems{'230'} = $i;
    ...
    $floor::floorLabels{$i} = 232;
    $floor::floorItems{'232'} = $i;
    ...
    $floor::floorLabels{$i} = 229;
    $floor::floorItems{'229'} = $i;
    ...
    $floor::floorLabels{$i} = 227;
    $floor::floorItems{'227'} = $i;
    ...
    $floor::floorLabels{$i} = 228;
    $floor::floorItems{'228'} = $i;
    ...
    $floor::floorLabels{$i} = 226;
    $floor::floorItems{'226'} = $i;
    ...
    $floor::floorLabels{$i} = 225;
    $floor::floorItems{'225'} = $i;
    ...
    $floor::floorLabels{$i} = 224;
    $floor::floorItems{'224'} = $i;
    ...
    $floor::floorLabels{$i} = 223;
    $floor::floorItems{'223'} = $i;
    ...
    $floor::floorLabels{$i} = 222;
    $floor::floorItems{'222'} = $i;
    ...
    $floor::floorLabels{$i} = 221;
    $floor::floorItems{'221'} = $i;
    ...
    $floor::floorLabels{$i} = 204;
    $floor::floorItems{'204'} = $i;
    ...
    $floor::floorLabels{$i} = 205;
    $floor::floorItems{'205'} = $i;
    ...
    $floor::floorLabels{$i} = 207;
    $floor::floorItems{'207'} = $i;
    ...
    $floor::floorLabels{$i} = 208;
    $floor::floorItems{'208'} = $i;
    ...
    $floor::floorLabels{$i} = 209;
    $floor::floorItems{'209'} = $i;
    ...
    $floor::floorLabels{$i} = 217;
    $floor::floorItems{'217'} = $i;
    ...
    $floor::floorLabels{$i} = '217A';
    $floor::floorItems{'217A'} = $i;
    ...
    $floor::floorLabels{$i} = 216;
    $floor::floorItems{'216'} = $i;
    ...
    $floor::floorLabels{$i} = 215;
    $floor::floorItems{'215'} = $i;
    ...
    $floor::floorLabels{$i} = 214;
    $floor::floorItems{'214'} = $i;
    ...
    $floor::floorLabels{$i} = 213;
    $floor::floorItems{'213'} = $i;
    ...
    $floor::floorLabels{$i} = 210;
    $floor::floorItems{'210'} = $i;
    ...
    $floor::floorLabels{$i} = 211;
    $floor::floorItems{'211'} = $i;
    ...
    $floor::floorLabels{$i} = 203;
    $floor::floorItems{'203'} = $i;
    ...
    $floor::floorLabels{$i} = 220;
    $floor::floorItems{'220'} = $i;
    ...
    $floor::floorLabels{$i} = 'Priv Lift2';
    $floor::floorItems{'Priv Lift2'} = $i;
    ...
    $floor::floorLabels{$i} = 'Pub Lift2';
    $floor::floorItems{'Pub Lift2'} = $i;
    ...
    $floor::floorLabels{$i} = 218;
    $floor::floorItems{'218'} = $i;
    ...
    $floor::floorLabels{$i} = 219;
    $floor::floorItems{'219'} = $i;
    ...
    $floor::floorLabels{$i} = 201;
    $floor::floorItems{'201'} = $i;
...
sub fg3 {;
    ...
    $floor::floorLabels{$i} = 316;
    $floor::floorItems{'316'} = $i;
    ...
    $floor::floorLabels{$i} = 309;
    $floor::floorItems{'309'} = $i;
    ...
    $floor::floorLabels{$i} = 308;
    $floor::floorItems{'308'} = $i;
    ...
    $floor::floorLabels{$i} = 307;
    $floor::floorItems{'307'} = $i;
    ...
    $floor::floorLabels{$i} = 305;
    $floor::floorItems{'305'} = $i;
    ...
    $floor::floorLabels{$i} = '324B';
    $floor::floorItems{'324B'} = $i;
    ...
    $floor::floorLabels{$i} = '324A';
    $floor::floorItems{'324A'} = $i;
    ...
    $floor::floorLabels{$i} = 320;
    $floor::floorItems{'320'} = $i;
    ...
    $floor::floorLabels{$i} = 310;
    $floor::floorItems{'310'} = $i;
    ...
    $floor::floorLabels{$i} = 312;
    $floor::floorItems{'312'} = $i;
    ...
    $floor::floorLabels{$i} = 313;
    $floor::floorItems{'313'} = $i;
    ...
    $floor::floorLabels{$i} = 314;
    $floor::floorItems{'314'} = $i;
    ...
    $floor::floorLabels{$i} = 315;
    $floor::floorItems{'315'} = $i;
    ...
    $floor::floorLabels{$i} = '316B';
    $floor::floorItems{'316B'} = $i;
    ...
    $floor::floorLabels{$i} = '316A';
    $floor::floorItems{'316A'} = $i;
    ...
    $floor::floorLabels{$i} = 319;
    $floor::floorItems{'319'} = $i;
    ...
    $floor::floorLabels{$i} = 311;
    $floor::floorItems{'311'} = $i;
    ...
    $floor::floorLabels{$i} = 318;
    $floor::floorItems{'318'} = $i;
    ...
    $floor::floorLabels{$i} = 317;
    $floor::floorItems{'317'} = $i;
    ...
    $floor::floorLabels{$i} = 323;
    $floor::floorItems{'323'} = $i;
    ...
    $floor::floorLabels{$i} = 325;
    $floor::floorItems{'325'} = $i;
    ...
    $floor::floorLabels{$i} = 321;
    $floor::floorItems{'321'} = $i;
    ...
    $floor::floorLabels{$i} = 322;
    $floor::floorItems{'322'} = $i;
    ...
    $floor::floorLabels{$i} = 'Pub Lift3';
    $floor::floorItems{'Pub Lift3'} = $i;
    ...
    $floor::floorLabels{$i} = 'Priv Lift3';
    $floor::floorItems{'Priv Lift3'} = $i;
    ...
    $floor::floorLabels{$i} = 303;
    $floor::floorItems{'303'} = $i;
    ...
    $floor::floorLabels{$i} = 324;
    $floor::floorItems{'324'} = $i;
    ...
    $floor::floorLabels{$i} = 304;
    $floor::floorItems{'304'} = $i;
    ...
    $floor::floorLabels{$i} = 301;
    $floor::floorItems{'301'} = $i;
    ...
    $floor::floorLabels{$i} = 327;
    $floor::floorItems{'327'} = $i;
    ...
    $floor::floorLabels{$i} = 326;
    $floor::floorItems{'326'} = $i;
    ...
    $floor::floorLabels{$i} = 302;
    $floor::floorItems{'302'} = $i;
    ...
    $floor::floorLabels{$i} = 306;
    $floor::floorItems{'306'} = $i;
...
# currentRoom is tied to package "floor" for tracing purposes.  All other
