 ...
 *	message is left in Tcl_GetResult(interp).  The caller should never
 ...
 *	returned and a message is left in Tcl_GetResult(interp).
 *
 * Side effects:
 ...
 *	Tcl_GetResult(interp).  The caller should never modify the bitmap that
