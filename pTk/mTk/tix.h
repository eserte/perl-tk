...
COREXT TIX_DECLARE_CMD(Tix_InputOnlyCmd);
COREXT TIX_DECLARE_CMD(Tix_MwmCmd);
COREXT TIX_DECLARE_CMD(Tix_NoteBookFrameCmd);
...
COREXT Tk_CustomOption tixConfigRelief;
...
COREXT int		Tix_ValueMissingError _ANSI_ARGS_((Tcl_Interp *interp,
			    char *spec));
COREXT Tcl_Interp *	Tix_WishInit _ANSI_ARGS_((int *argcPtr, char **argv,
