...
static Tk_OptionSpec entryOptSpec[] = {
	...
	DEF_ENTRY_INVALIDCMD, Tk_Offset(Entry, invalidCmd), -1,
	TK_OPTION_NULL_OK, 0, 0},
	...
	DEF_ENTRY_TEXT_VARIABLE, Tk_Offset(Entry, textVarName), -1,
	TK_OPTION_NULL_OK, 0, 0},
    {TK_OPTION_STRING_TABLE, "-validate", "validate", "Validate",
       DEF_ENTRY_VALIDATE, -1, Tk_Offset(Entry, validate),
       0, (ClientData) validateStrings, 0},
    {TK_OPTION_STRING, "-validatecommand", "validateCommand", "ValidateCommand",
       (char *) NULL, Tk_Offset(Entry, validateCmd), -1,
       TK_OPTION_NULL_OK, 0, 0},
	...
	DEF_ENTRY_SCROLL_COMMAND, Tk_Offset(Entry, scrollCmd), -1,
	TK_OPTION_NULL_OK, 0, 0},
