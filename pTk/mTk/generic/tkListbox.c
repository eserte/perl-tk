...
static Tk_OptionSpec optionSpecs[] = {
    ...
    {TK_OPTION_STRING, "-xscrollcommand", "xScrollCommand", "ScrollCommand",
	 DEF_LISTBOX_SCROLL_COMMAND, Tk_Offset(Listbox, xScrollCmd), -1,
	 TK_OPTION_NULL_OK, 0, 0},
    {TK_OPTION_STRING, "-yscrollcommand", "yScrollCommand", "ScrollCommand",
	 DEF_LISTBOX_SCROLL_COMMAND, Tk_Offset(Listbox, yScrollCmd), -1,
	 TK_OPTION_NULL_OK, 0, 0},
    {TK_OPTION_STRING, "-listvariable", "listVariable", "Variable",
	 DEF_LISTBOX_LIST_VARIABLE, Tk_Offset(Listbox, listVarName), -1,
	 TK_OPTION_NULL_OK, 0, 0},
