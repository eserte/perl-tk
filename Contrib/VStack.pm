# $Id: VStack.pm,v 1.2 1996/09/01 21:52:46 rsi Exp $
#
# Virtual base class needed to implement the NoteBook widget.
...
#
# $Log: VStack.pm,v $
# Revision 1.2  1996/09/01 21:52:46  rsi
# Fixed size calculation bug which caused the size of the last page
# (instead of the size of the largest page) to be used as the size for
# the notebook.
#
# Revision 1.1  1996/08/29 21:46:13  rsi
# Initial revision
#
#
