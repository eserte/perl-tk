...
sub items {
    ...
    $c->create(qw/line 20c  0c 20c 24c -width 2/);
     ...
     $c->create(qw/grid 0c  0c 10c 8c -width 2 -lines 1/);
     $c->create(qw/grid 0c  0c 5c  4c -lines 1 -dash ./);
     $c->create(qw/grid 0c  0c 10m 8m -width 1/);
    }
    ...
    $c->create(qw/line 4.67c 1c 4.67c 4c -arrow last -activedash - -tags item/);
    $c->create(qw/line 6.33c 1c 6.33c 4c -arrow both -activedash . -tags item/);
